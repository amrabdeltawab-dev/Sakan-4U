...
begin
  if coalesce(new.raw_user_meta_data ->> 'legal_consent', 'false') <> 'true' then
    raise exception 'يجب قبول الشروط والأحكام وسياسة الخصوصية قبل إنشاء الحساب.' using errcode = '23514';
  end if;
