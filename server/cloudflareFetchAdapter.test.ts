...
describe("Cloudflare tRPC Fetch Adapter entrypoint", () => {
  ...
  it("wires all requested booking notification transitions through the shared utility", () => {
    ...
    expect(router).toContain('sendBookingNotificationToStudent("cancelled"');
    expect(router).toContain('sendBookingNotificationToOwner("cancelled"');
    expect(router).toContain('sendBookingNotificationToStudent("rescheduled"');
    expect(router).toContain('sendBookingNotificationToOwner("rescheduled"');
    expect(router).toContain('sendBookingNotificationToOwner("student_confirmed"');
    expect(router).toContain('sendPropertyReviewEmail');
    expect(router).toContain('sendPropertySubmittedEmail');
    expect(router).toContain('sendOwnerLeadEmail');
